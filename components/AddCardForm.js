...
class AddCardForm extends React.Component {
  ...
  render() {
    return (
      ...
      <TextInput style={styles.inputField}
        ...
        onChangeText={question => this.setState({question})} placeholder="Question"
      />
      <TextInput style={styles.inputField}
        value={this.state.answer}
        onChangeText={answer => this.setState({answer})} placeholder="Answer"
      />
  ...
  _submitForm = () => {
    ...
    ToastAndroid.show("Question added to deck successfully!", ToastAndroid.SHORT)
  }
